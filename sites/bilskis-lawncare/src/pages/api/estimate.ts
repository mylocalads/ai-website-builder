...
// Must stay in lockstep with SERVICES in src/components/EstimateForm.astro —
// anything the form can submit that is missing here is rejected as ?error=service.
const SERVICES = new Set([
  'Commercial snow removal',
  'Drainage / erosion work',
  'Hedge trimming',
