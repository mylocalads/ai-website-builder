 ...
 *  Raised 5 -> 7 for Infinity Roofing: 6 client services + Solar Installation,
 *  each of which the operator wants a real page for. */
export const SERVICE_LIMIT = 7;

/** Service-area pages generated, and areas shown in nav/grid.
 *  Raised 6 -> 7 for Infinity Roofing: Dallas (HQ) plus 6 outlying towns. */
export const AREA_LIMIT = 7;
