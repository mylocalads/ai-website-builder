...
// MUST stay in sync with the SERVICES array in components/EstimateForm.astro.
// This is the server-side allowlist: a value the form offers but this set does
// not contain is rejected as an invalid submission, which silently drops the
// lead.
