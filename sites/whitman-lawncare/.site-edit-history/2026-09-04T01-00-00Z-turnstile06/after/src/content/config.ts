  ...
  schema: z.discriminatedUnion('kind', [
    z.object({
      ...
      crm: z.object({
        ...
        // Cloudflare Turnstile. The site key is public and belongs in content;
        // the matching secret is TURNSTILE_SECRET_KEY on the deployment, which
        // is what api/estimate.ts verifies against. Set one without the other
        // and the form is NOT protected — with no secret the endpoint skips
        // verification entirely.
        turnstile_site_key: z.string().optional(),
        // Legacy paste-in for a hand-configured captcha.
