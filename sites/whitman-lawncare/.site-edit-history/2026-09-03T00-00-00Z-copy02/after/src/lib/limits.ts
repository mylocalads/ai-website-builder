 ...
 *
 * Whitman authors 10 towns across Lackawanna, Luzerne and Monroe counties, so
 * this is 10 rather than the template default. Every one has its own local
 * conditions written for it — raise this only alongside real content, never to
 * accommodate near-duplicate pages.
 */
export const AREA_LIMIT = 10;
