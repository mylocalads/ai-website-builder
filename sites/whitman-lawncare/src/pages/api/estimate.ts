...
// Must stay in step with the dropdown in EstimateForm.astro, which builds its
// options from the services collection. A value missing here is rejected as
// error=service, so any change to src/content/services/ belongs here too.
