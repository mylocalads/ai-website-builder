...
// MUST stay in sync with the SERVICES list in src/components/EstimateForm.astro.
// A value in the form but missing here fails validation as `service` and the
// lead bounces back to the page with an error.
const SERVICES = new Set([
  'Air conditioning installation',
  'Air conditioning repair',
  'Boiler repair or replacement',
  'Ductless mini-split',
  'Ductwork or indoor air quality',
  'Emergency — no heat',
