...
export const addOns = [
  ...
  },
  {
    ...
    // Copy mirrors the live Stripe product description, so the card and the
    // checkout page make the same promise — including the exclusion.
    subtitle: 'Facebook & Instagram management that keeps you in front of local homeowners.',
    priceCents: 50000,
    priceLabel: '$500/mo',
    wasPriceLabel: null,
    priceNote: 'Up to 12 posts monthly. In-person content production not included.',
    billing: 'recurring',
    trialDays: null,
    requires: [],
    group: null,
