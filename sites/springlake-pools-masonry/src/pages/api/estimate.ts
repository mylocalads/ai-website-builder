...
// MUST stay in sync with the dropdown in EstimateForm.astro, which builds its
// options from the services content collection. A mismatch here rejects real
// submissions with ?error=service.
const SERVICES = new Set([
  'Custom Pool & Spa Construction',
  'Pool Renovation & Remodeling',
  'Pool Repair Service',
  'Pool Cleaning & Maintenance',
  'Masonry & Outdoor Living',
  'Other',
]);
